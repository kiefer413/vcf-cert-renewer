...
def isolated_host_configuration():
    with patch.dict(os.environ, {"PATH": os.environ.get("PATH", "/usr/bin:/bin"),
                                 "HOME": "/nonexistent-vcf-test"}, clear=True), patch('vcf_cert_renewer.config.DEFAULT_CONFIG_PATH', Path('/nonexistent-vcf-test/config.yaml')), \
